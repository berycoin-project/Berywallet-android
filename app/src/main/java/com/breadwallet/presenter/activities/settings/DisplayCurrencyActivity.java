...
//    private float rate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (unit == BRConstants.CURRENT_UNIT_BERYCOINS) {
            setButton(true);
        } else {
            setButton(false);
        }
    ...
    private void updateExchangeRate() {
        ...
        if (entity != null) {
            ...
            boolean beryflowers = BRSharedPrefs.getCurrencyUnit(this) == BRConstants.CURRENT_UNIT_BERYFLOWERS;
            exchangeText.setText(BRCurrency.getFormattedCurrencyString(this, "BERY", new BigDecimal(beryflowers ? 1000 : 1)) + " = " + finalExchangeRate);
        }
        adapter.notifyDataSetChanged();
    }
    ...
    private void setButton(boolean left) {
        if (left) {
            BRSharedPrefs.putCurrencyUnit(this, BRConstants.CURRENT_UNIT_BERYCOINS);
            ...
            BRSharedPrefs.putCurrencyUnit(this, BRConstants.CURRENT_UNIT_BERYFLOWERS);
